...
export default function Header() {
  ...
  return (
    ...
    >
      <nav className="flex items-center justify-between px-8 py-1 max-w-[80rem] w-full text-primary font-bold">
        <Link href="/" className="">
          <Image
            src={Logo}
            alt="dm rustic 24"
